defmodule SecretQuestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SecretQuestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SecretQuestWeb.Gettext, "errors", msg, opts)
    end
  end
